    ...
    <section className="settings-section">
      ...
      <div className="settings-section-subtitle">
        {isMobileSimplified
          ...
          : "Configure how CodexOps exposes backend access for mobile and remote clients. Desktop usage remains local unless you explicitly connect through remote mode."}
      </div>
          ...
          <div className="settings-toggle-row">
            <div>
              ...
              <div className="settings-toggle-subtitle">
                If disabled, CodexOps stops managed TCP and Orbit daemon processes before exit.
              </div>
            </div>
            <button
              type="button"
        ...
        {appSettings.remoteBackendProvider === "tcp" && (
          <>
            <div className="settings-field">
              ...
              <div className="settings-help">
                {isMobileSimplified
                  ? "Use the Tailscale host from your desktop CodexOps app (Server section), for example `macbook.your-tailnet.ts.net:4732`."
      ...
      <div className="settings-help">
        {isMobileSimplified
          ? appSettings.remoteBackendProvider === "tcp"
            ? "Use your own infrastructure only. On iOS, get the Tailscale hostname and token from your desktop CodexOps setup."
            : "Use your own infrastructure only. On iOS, use the Orbit websocket URL and token configured on your desktop CodexOps setup."
          : "Mobile access should stay scoped to your own infrastructure (tailnet or self-hosted Orbit). CodexOps does not provide hosted backend services."}
      </div>
    </section>
  );
}
